...
server.tool(
  ...
  "List tasks in a project with optional filters",
  {
    ...
    status: z.string().optional().describe("Filter by status (comma-separated): planned, todo, in_progress, in_review, ready_to_test, in_testing, done"),
...
server.tool(
  "change_task_status",
  "Change the status of a task. Valid: planned, todo, in_progress, in_review, ready_to_test, in_testing, done",
  {
    taskKey: z.string().describe("Task key (e.g. 'CP-1')"),
